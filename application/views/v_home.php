...
<!--[if gt IE 8]><!--> <html class="no-js"> <!--<![endif]-->
	...
	<title>Travel Ticket Nusantara &mdash; </title>
		...
		<header id="fh5co-header-section" class="sticky-banner">
			<div class="container">
				<div class="nav-header">
					...
					<h1 id="fh5co-logo"><a href="index.html"><i class="icon-airplane"></i>Travel Ticket Nusantara</a></h1>
						...
						<div class="row">
							...
							<div class="desc2 animate-box">
								<div class="col-sm-7 col-sm-push-1 col-md-7 col-md-push-1">
									...
									<h3>Terbang Ke Jakarta dari Jogjakarta</h3>
				...
				<div class="container">
					<div class="row row-bottom-padded-md">
						...
						<div class="col-md-6 col-md-offset-3 text-center">
							...
							<p>Copyright@M Tri Fakhreri Arsyad</p>
						</div>
					</div>
				</div>
			</div>
